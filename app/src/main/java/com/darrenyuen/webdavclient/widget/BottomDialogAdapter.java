package com.darrenyuen.webdavclient.widget;
...
import com.darrenyuen.webdavclient.util.LayoutUtil;
...
public class BottomDialogAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    class VerticalViewHolder extends RecyclerView.ViewHolder {
        ...
        public VerticalViewHolder(@NonNull View itemView) {
            ...
            item.setCompoundDrawablePadding(ConvertUtil.INSTANCE.dpToPx(context, paddingInItem));
            item.setPadding(ConvertUtil.INSTANCE.dpToPx(context, padding), 0, 0, ConvertUtil.INSTANCE.dpToPx(context, padding));
            ((LinearLayout) itemView).addView(item);
        }

        private Drawable getIcon(Drawable drawable) {
            if (drawable != null) {
                Bitmap bitmap = ConvertUtil.INSTANCE.drawableToBitmap(drawable);
    ...
    class HorizontalViewHolder extends RecyclerView.ViewHolder {
        ...
        public HorizontalViewHolder(@NonNull View itemView) {
            ...
            params.width = LayoutUtil.INSTANCE.getScreenWidth(context) / count;
